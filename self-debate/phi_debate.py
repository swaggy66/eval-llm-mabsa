    ...
    return [
        {
            ...
            "content": (
                ...
                # "Please review and comment on the following response. Provide corrections if necessary or add more details to improve the result:\n"
                # "Commentary:"
                 '''
                Aspect-Based Sentiment Analysis (ABSA) involves identifying specific entity (such as a person, product, service, or experience) mentioned in a text and determining the sentiment expressed toward each entity. 
                Each entity is associated with a sentiment that can be [positive, negative, or neutral].
    ...
    return [
        {
            ...
            "content": (
                ...
                # "Based on the initial response and commentary, please further debate and refine the analysis. If there are any conflicting opinions or uncertainties, resolve them and provide a more detailed and accurate response.\n"
...
def analyze_sentiments(file_path, output_file_path):
    ...
    for sentence in tqdm(sentences):
        ...
        outputs_1 = chatbot(initial_messages, max_new_tokens=520,do_sample=False,return_full_text=False,temperature=0.0)
        response_1 = outputs_1[0]["generated_text"] #outputs_1[0]["generated_text"][1]["content"]
        ...
        outputs_2 = chatbot(commentary_messages, max_new_tokens=512, do_sample=False,return_full_text=False,temperature=0.0)
        ...
        outputs_3 = chatbot(second_round_messages, max_new_tokens=512, do_sample=False,return_full_text=False,temperature=0.0)
...
output_file_path = f"./results/phi_debate_{args.test_lang}_results.json"
analyze_sentiments(file_path, output_file_path)

# python Debate/phi_debate.py  --lang en --test_lang [en,nl,es,ru,fr]