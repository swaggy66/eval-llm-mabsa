...
local_model_path = "/data/gemma_instruct"
...
'''
        ...
        results.append({
            ...
            "topk_similar_sentences": topk_sentences_with_entities  # 保存topk的相似句子
        })
...
output_json_path = f"/data/result/gemma_fewshot_results_{args.test_lang}.json"
