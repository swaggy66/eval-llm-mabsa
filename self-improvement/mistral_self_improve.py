...
output_file = f"./results/mistral_self_inprove_{args.test_lang}_results.json"


analyze_sentiments(file_path, output_file)

# python Self-Improvement/mistral_self_improve.py  --lang en --test_lang [en,nl,es,ru,fr]