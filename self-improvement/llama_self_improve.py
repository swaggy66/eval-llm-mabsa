...
def analyze_sentiments(file_path, output_file):
    ...
    for i, sentence in enumerate(sentences):
        ...
        #print('111',explanation_prompt_with_result)
...
output_file = f"./results/llama_self_inprove_{args.test_lang}_results.json"


analyze_sentiments(file_path, output_file)

# python Self-Improvement/llama_self_improve.py  --lang en --test_lang [en,nl,es,ru,fr]