...
output_json_path = f"./results/qwen_CoT_{args.test_lang}_results.json"

# Perform sentiment analysis
analyze_sentiments(file_path, output_json_path)

# python CoT/qwen_CoT.py  --lang en --test_lang [en,nl,es,ru,fr]
