...
'''
        ...
        messages = chatbot.tokenizer.apply_chat_template(messages, tokenize=False, add_generation_prompt=True,do_sample=True)
        outputs = chatbot(messages, max_new_tokens=512,do_sample=True, temperature=args.temp)
...
output_json_path = f"/data/zephyr_consistency_results_{args.test_lang}_{args.temp}.json"
