...
output_json_path = f"./results/llama_consistency_results_{args.test_lang}_{args.temp}.json"


analyze_sentiments(file_path, output_json_path)

# python Self-Consistence/llama_self_consistency.py  --lang en --test_lang [en,nl,es,ru,fr] --temp [0.2, 0.4, 0.6, 0.8, 1]